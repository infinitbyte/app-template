...
# APP info
APP_NAME := TEMPLATE-APP-NAME-LOWERCASE
APP_VERSION := 0.0.1_SNAPSHOT
...
init:
	...
	@if [ ! -d $(FRAMEWORK_FOLDER) ]; then echo "framework does not exist";(cd $(FRAMEWORK_FOLDER)../&&git clone -b $(FRAMEWORK_BRANCH) https://github.com/infinitbyte/framework.git) fi
